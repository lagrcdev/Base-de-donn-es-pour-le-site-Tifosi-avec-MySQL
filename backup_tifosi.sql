...
CREATE TABLE `achete` (
  ...
  KEY `fk_achete_client` (`id_client`),
...
CREATE TABLE `focaccia` (
  ...
  KEY `fk_focaccia_menu` (`id_menu`),
  CONSTRAINT `fk_focaccia_menu` FOREIGN KEY (`id_menu`) REFERENCES `menu` (`id_menu`)
...
INSERT INTO `focaccia` VALUES (1,'Mozaccia',9.8,NULL),(2,'Gorgonzollaccia',10.8,NULL),(3,'Raclaccia',8.9,NULL),(4,'Emmentalaccia',9.8,NULL),(5,'Tradizione',8.9,NULL),(6,'Hawaienne',11.2,NULL),(7,'Américaine',10.8,NULL),(8,'Paysanne',12.8,NULL);
...
CREATE TABLE `focaccia_ingredient` (
  ...
  KEY `fk_fi_ingredient` (`id_ingredient`),
...
INSERT INTO `focaccia_ingredient` VALUES (1,1),(1,3),(1,5),(1,7),(1,9),(1,13),(1,16),(1,18),(1,20),(1,25),(2,1),(2,5),(2,7),(2,9),(2,11),(2,16),(2,18),(2,20),(3,1),(3,5),(3,7),(3,9),(3,18),(3,20),(3,22),(4,6),(4,7),(4,9),(4,10),(4,15),(4,18),(4,20),(5,5),(5,7),(5,9),(5,12),(5,16),(5,17),(5,18),(5,20),(5,25),(6,2),(6,4),(6,5),(6,9),(6,16),(6,18),(6,19),(6,20),(6,25),(7,4),(7,5),(7,9),(7,16),(7,18),(7,20),(7,21),(7,25),(8,1),(8,3),(8,6),(8,7),(8,8),(8,9),(8,13),(8,14),(8,16),(8,18),(8,20),(8,21);
...
CREATE TABLE `paye` (
  ...
  CONSTRAINT `fk_paye_menu` FOREIGN KEY (`id_menu`) REFERENCES `menu` (`id_menu`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-09-11 17:58:24
